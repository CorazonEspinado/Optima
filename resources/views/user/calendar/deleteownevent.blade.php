<div class="modal fade" id="deleteownevent" tabindex="-1" role="dialog" aria-labelledby="calendarform1" aria-hidden="true" >
...
<input type="text" name="userdeleteid" id="userdeleteid" hidden></p>
                ...
                <div class="modal-footer">
                    <input type="submit" class="btn btn-danger  pull-left" id="UserDeleteEvent" value="Удалить">
